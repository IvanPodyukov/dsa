...
urlpatterns = [
    ...
    path('<pk>/participants/<int:participant_pk>/confirm-clear/', views.ConfirmClearParticipantView.as_view(),
         name='confirm_clear_participant'),
    path('<pk>/participants/<int:participant_pk>/clear/', views.ClearParticipantView.as_view(),
