...
urlpatterns = [
    ...
    path('<pk>/participants/<int:participant_pk>/confirm-clear/', views.ParticipantConfirmClearView.as_view(),
         name='confirm_clear_participant'),
    path('<pk>/participants/<int:participant_pk>/clear/', views.ParticipantClearView.as_view(),
